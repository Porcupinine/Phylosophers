...
/*   Updated: 2023/10/26 23:07:58 by laura         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	philos_data->start_mut = ft_calloc(1, sizeof (pthread_mutex_t));
	if (philos_data->start_mut == NULL)
		return (1);
	if (pthread_mutex_init(philos_data->start_mut, NULL) != 0)
		return (1);
	...
	if (pthread_mutex_init(philos_data->message, NULL) != 0)
		return (1);
