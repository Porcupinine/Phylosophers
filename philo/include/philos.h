...
/*   Updated: 2023/10/30 11:35:13 by lpraca-l      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * set the numbers for left and right fork
 * left fork i set as philo number -1 (to get the fork that occupies 
 * the same position as the philo) and right fork is the module of 
 * philo number for amount of philos (to get next position)
 * unless the philo is the last one, in wich case left fork is set
 * to 0 and right fork is set to 
*/
